function dummyDataFunc() {
  ...
  const user1 = { _id: '645449c2d0215be49c7e1300', description: 'Desc',
                  displayName: 'ab', filename: 'seagull.jpg', firstName: 'a',
               lastName: 'b', loginName: 'ab', loginPassword: 'ab' };

  const user2 = { _id: '645449c2d0215be49c7e1301', description: 'Desc',
                  displayName: 'bc', filename: 'seagull.jpg', firstName: 'b', 
                  lastName: 'c', loginName: 'bc', loginPassword: 'bc' };

  const fakeUsers = [user1, user2];

  /* Fake battles.  */
  const battle1 = { _id: '64544bf83f9238e774994e00',
                    author: user1._id, caption: 'battle1',
                    creationTime: '2023-05-05T00:24:14.710Z',
                    deadline: '2023-05-05T00:26:13.696Z',
                    filename: 'cat.jpeg' }

  const battle2 = { _id: '64544bf83f9238e774994e01',
                    author: user2._id, caption: 'battle2',
                    creationTime: '2023-05-05T00:24:14.710Z',
                    deadline: '2023-05-05T00:26:13.696Z',
